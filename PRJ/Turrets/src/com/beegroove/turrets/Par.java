...
public class Par {
	...
	public static final int INITIAL_COUNTDOWN = 6000*3;
	public static final int INITIAL_WAVE_NUMBER = 40;
	public static final int STANDARD_FONT_SIZE = 26;
	public static final int LARGE_FONT_SIZE = 34;
	public static final int MAIN_TITLE_FONT_SIZE = 70;
	...
	public static final Vector3 TURRET_LIGHT_FIRING_POSITION 	= new Vector3(-25f, 0, 0);
